...
You can absolutely build this yourself in a few hours — **the full source code is right here.** But if your time is worth more than $4.99, `install.bat` takes five seconds. I already did the debugging, the MSYS2 workarounds, and the Windows Toast API arcana so you don't have to.
